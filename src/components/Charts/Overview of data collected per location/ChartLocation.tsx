...
const chartData = {
  overview: [
    { name: '360 Images', data: [0, 11, 11, 10, 7, 10] },
    { name: 'Images', data: [0, 0, 0, 0, 0, 0] },
    { name: 'Video', data: [0, 0, 0, 0, 0, 0] },
    { name: 'Point Cloud', data: [0, 11, 9, 0, 0, 0] },
  ],
  room1: [{ name: 'Data', data: [0, 0, 0, 0] }],
  room2: [{ name: 'Data', data: [11, 0, 0, 11] }],
  room3: [{ name: 'Data', data: [11, 0, 0, 9] }],
  room4: [{ name: 'Data', data: [10, 0, 0, 0] }],
  room5: [{ name: 'Data', data: [7, 0, 0, 0] }],
  room6: [{ name: 'Data', data: [10, 0, 0, 0] }],
};
      ...
      <div className="mb-4 justify-between gap-4 sm:flex">
        <div>
          <h4 className="text-xl font-semibold text-black dark:text-white">
            {hoveredRoom && hoveredRoom !== 'overview' ? `Data Collected in ${hoveredRoom.charAt(0).toUpperCase() + hoveredRoom.slice(1)}` : 'Overview of Data Collected'}
          </h4>
        </div>
      </div>
      <div>
